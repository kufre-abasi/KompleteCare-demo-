...
import { u as useHead } from './v3-D_YqYA44.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "antialiased bg-white dark:bg-black dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-black" }, _attrs))} data-v-8a5bd163><div class="fixed left-0 right-0 spotlight z-10" data-v-8a5bd163></div><div class="max-w-520px text-center z-20" data-v-8a5bd163><h1 class="font-medium mb-8 sm:text-10xl text-8xl" data-v-8a5bd163>${ssrInterpolate(__props.statusCode)}</h1><p class="font-light leading-tight mb-16 px-8 sm:px-0 sm:text-4xl text-xl" data-v-8a5bd163>${ssrInterpolate(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-8a5bd163>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.17.1_@netlify+blobs@8.2.0_@parcel+watcher@2.5.1_@types+node@22.15.3_db0@0.3.2_eslint@9_3ceug5cg7mpp3gjd2rzq7cmrre/node_modules/nuxt/dist/app/components/error-404.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const error404 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-8a5bd163"]]);

export { error404 as default };
//# sourceMappingURL=error-404-CRE8npqg.mjs.map
